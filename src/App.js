...
const tld = ".smoe";
const CONTRACT_ADDRESS = '0x3622937273af168BE531cb5E7328800F67CA15C8';
	...
	const renderInputForm = () => {
		...
		return (
			<div className="form-container">
				...
				<input type="text" value={record} placeholder="Enter your description" onChange={(e) => setRecord(e.target.value)} />
				{editing ? (
		...
		<div className="App">
			<div className="container-1">
				<div className="header-container">
					<header>
						<div className="left">
							<p className="title">🐱‍👤 Smoe Name Service</p>
						</div>
